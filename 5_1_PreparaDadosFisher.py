...
class PreparaDadosFisher():
    ...
    def fisher_treina_data(self):
        ...
        self.model.write('Dados/Recognizer/dadosPreparadosFisher.yml')
        print ("Treinamento dos dados completados com sucesso")
        return

if __name__ == '__main__':
    treinar = PreparaDadosFisher()
    treinar.fisher_treina_data()
